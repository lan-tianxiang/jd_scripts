...
!function (t, r) { "object" == typeof exports ? module.exports = exports = r() : "function" == typeof define && define.amd ? define([], r) : t.CryptoJS = r() }(this, function () {
      ...
      if (item['taskType'] === 'ScanMarket') {
        ...
        for (let scanMarketItem of scanMarketList) {
          if (!scanMarketItem.status) {
            ...
            console.log(`逛会场-${scanMarketItem.marketName}`)
      ...
      if (item['taskType'] === 'FollowChannel') {
        ...
        for (let followChannelItem of followChannelList) {
          if (!followChannelItem.status) {
            ...
            const scanMarketRes = await scanMarket('scan', body);
            console.log(`浏览频道-${followChannelItem.channelName}`)
      ...
      if (item['taskType'] === 'FollowGood') {
        ...
        for (let followGoodItem of followGoodList) {
          if (!followGoodItem.status) {
            ...
            console.log(`关注商品-${followGoodItem.skuName}`)
  ...
  function getDeskGoodDetails() {
    return new Promise(resolve => {
      ...
      const reqSource = 'h5';
      let opt = {
        url: "//jdjoy.jd.com/common/pet/getDeskGoodDetails?reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC",
  ...
  function followScan(sku) {
    return new Promise(resolve => {
      ...
      let opt = {
        url: "//jdjoy.jd.com/common/pet/scan?reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC",
        // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5",
        method: "POST",
        data: body,
        credentials: "include",
  ...
  function scanMarket(type, body, cType = 'application/json') {
    return new Promise(resolve => {
      ...
      let opt = {
        ...
        url: `//draw.jdfcloud.com/common/pet/${type}?reqSource=weapp&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC`,
        method: "POST",
        data: body,
        credentials: "include",
  ...
  function getFood(type) {
    return new Promise(resolve => {
      ...
      let opt = {
        // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
        url: `//draw.jdfcloud.com/common/pet/getFood?reqSource=weapp&taskType=${type}&reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC`,
        method: "GET",
        data: {},
        credentials: "include",
        header: {"content-type": "application/json"}
  ...
  function followShop(shopId) {
    return new Promise(resolve => {
      ...
      let opt = {
        // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
        url: "//draw.jdfcloud.com/common/pet/followShop?reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC",
        method: "POST",
        data: body,
        credentials: "include",
  ...
  function enterRoom() {
    return new Promise(resolve => {
      ...
      let opt = {
        // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
        url: `//draw.jdfcloud.com/common/pet/enterRoom/h5?invitePin=&reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC`,
        method: "GET",
        data: {},
        credentials: "include",
        header: {"content-type": "application/json"}
  ...
  function appGetPetTaskConfig() {
    return new Promise(resolve => {
      ...
      const reqSource = 'h5';
      let opt = {
        url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC",
        method: "GET",
        data: {},
        credentials: "include",
        header: {"content-type": "application/json"}
      ...
      $.get(taskUrl(url, host, reqSource), (err, resp, data) => {
        try {
          if (err) {
            ...
            //console.log('AAAAAAAAAAAAAAAAAAAA----', JSON.parse(data))
  ...
  function feedPets(feedNum) {
    return new Promise(resolve => {
      ...
      let opt = {
        // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
        url: `//draw.jdfcloud.com/common/pet/feed?feedCount=${feedNum}&reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC`,
        method: "GET",
        data: {},
        credentials: "include",
        header: {"content-type": "application/json"}
  ...
  function getPetTaskConfig() {
    return new Promise(resolve => {
      ...
      let opt = {
        // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
        url: "//draw.jdfcloud.com//common/pet/getPetTaskConfig?reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC",
        method: "GET",
        data: {},
        credentials: "include",
        header: {"content-type": "application/json"}
  ...
  function getPetRace() {
    return new Promise(resolve => {
      ...
      const reqSource = 'h5';
      let opt = {
        url: "//jdjoy.jd.com/common/pet/combat/detail/v2?help=false&reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC",
        // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5",
        method: "GET",
        data: {},
        credentials: "include",
  ...
  function getRankList() {
    return new Promise(resolve => {
      ...
      $.raceUsers = [];
      let opt = {
        url: "//jdjoy.jd.com/common/pet/combat/getRankList?reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC",
        // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5",
        method: "GET",
        data: {},
        credentials: "include",
  ...
  function runMatch(teamLevel, timeout = 5000) {
    ...
    return new Promise(async resolve => {
      ...
      const reqSource = 'h5';
      let opt = {
        url: `//jdjoy.jd.com/common/pet/combat/match?teamLevel=${teamLevel}&reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC`,
  ...
  function getBackupInfo() {
    return new Promise(resolve => {
      ...
      const reqSource = 'h5';
      let opt = {
        url: "//jdjoy.jd.com/common/pet/combat/getBackupInfo?reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC",
        // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5",
        method: "GET",
        data: {},
        credentials: "include",
  ...
  function getWinCoin() {
    return new Promise(resolve => {
      ...
      let opt = {
        // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
        url: "//draw.jdfcloud.com/common/pet/combat/detail/v2?help=false&reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC",
        method: "GET",
        data: {},
        credentials: "include",
        header: {"content-type": "application/json"}
  ...
  function receiveJoyRunAward() {
    return new Promise(resolve => {
      ...
      const reqSource = 'h5';
      let opt = {
        url: "//jdjoy.jd.com/common/pet/combat/receive?reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC",
        // url: "//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5",
        method: "GET",
        data: {},
        credentials: "include",
  ...
  function getSupplyInfo(showOrder) {
    return new Promise(resolve => {
      ...
      let opt = {
        // url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?reqSource=h5",
        url: `//draw.jdfcloud.com/common/pet/combat/getSupplyInfo?showOrder=${showOrder}&reqSource=h5&lks=f0b9f2ab1bb8382c14b7eb6e1ac1efc7&lkt=1622913165687&invokeKey=Oex5GmEuqGep1WLC`,
        method: "GET",
        data: {},
        credentials: "include",
        header: {"content-type": "application/json"}
